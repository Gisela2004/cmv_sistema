<?php
// public/usuarios.php - Listado de usuarios
session_start();
                            ...
                            <?php foreach ($usuarios as $usuario): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="usuario_eliminar.php?id=<?= $usuario['id_usuario'] ?>" class="btn btn-cmv-eliminar" onclick="return confirm('¿Eliminar este usuario?')">
